...
public class Lab121_String_Functions_Important {
    public static void main(String[] args) {
        String name = "Sonal";
        System.out.println(name.length());   //Index starts from 0 so the length is 7
        ...
        String S10 = "Niagara. O roar again!";
        String roar = S10.substring(11, 15);
